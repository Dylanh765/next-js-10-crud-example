...
function AddEditSound(props) {
    const sound = props?.sound;
    const isAddMode = !sound;
    ...
    if (!isAddMode) {
        const { password, confirmPassword, ...defaultValues } = sound;
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            <h1>{isAddMode ? 'Add Sound' : 'Edit Sound'}</h1>
